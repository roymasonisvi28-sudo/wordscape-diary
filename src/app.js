(function () {
  ...
  function characters() { shell(`<header><p class="eyebrow">CHARACTER ARCHIVE</p><h1>角色档案</h1><p>她们有自己的目标，也会在共同学习中慢慢改变。偶尔，也会有计划之外的人闯进来。</p></header>${characterCards()}${bananaArchiveCard()}`); }
